// REPL driver for ClipRename Desktop. Run under xvfb on headless Linux.
...
const COMMANDS = {
  ...
  async 'stub-picker'(dir) {
    if (!app) return console.log('ERROR: launch first');
    const r = await app.evaluate(({ dialog }, d) => {
...
console.log('cliprename driver — "help" for commands, "launch" to start');
rl.prompt();
